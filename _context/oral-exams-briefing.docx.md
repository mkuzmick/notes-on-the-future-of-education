...
Prepared by the Bok Center for Teaching and Learning

Harvard University

February 2026

Research synthesis based on 65+ sources across eight thematic domains.

This document is intended for internal faculty discussion and curriculum development.

**Contents**

# **Executive Summary**

Written assessment in higher education faces an epistemic crisis. With [88% of UK undergraduates](https://www.timeshighereducation.com/news/nine-10-uk-undergraduates-now-using-ai-assessments-survey) now using generative AI in their coursework[^1]—up from 53% just one year earlier—and detection tools achieving only 33–81% accuracy, the written essay can no longer reliably indicate whether a student understands the material they have submitted. As one NYU student told [*The New Yorker*](https://www.newyorker.com/magazine/2025/07/07/the-end-of-the-english-paper) in June 2025, “Any type of writing in life, I use A.I.”[^2] When asked if this constituted cheating, he replied: “Of course. Are you fucking kidding me?”

This briefing argues that oral assessment is not merely a defensive response to generative AI but a recovery of higher education’s founding pedagogy, supported by robust evidence from cognitive science, decades of scholarship of teaching and learning (SoTL), and the continuous practice of elite professional schools. For five hundred years—from the founding of the University of Bologna in 1088 through the eighteenth century—oral disputation was not a supplement to academic assessment; it [was the assessment](https://www.tandfonline.com/doi/abs/10.1080/09695940120033243).[^3] Written examinations emerged in the 1700s and 1800s driven by the scale demands of industrialization, not by any pedagogical discovery that writing tests understanding better than speech.
...
# **II. The Cognitive Science Case: Why Speaking Deepens Learning**
...
[Iannone and Simpson’s influential study](https://link.springer.com/article/10.1007/s10649-020-09937-4) found that oral assessment shifts students from surface to deep learning approaches.[^15] The unpredictability of dialogue—not knowing exactly which question will come next or how the examiner will probe a response—prevents the rote preparation strategies that written exams incentivize. Students cannot memorize their way through an oral exam the way they can through a written one; they must understand material well enough to discuss it from any angle.
...
# **III. The Global Landscape: How Peer Institutions Are Responding**
...
[Oxford and Cambridge banned ChatGPT](https://inews.co.uk/news/oxford-cambridge-ban-chatgpt-plagiarism-universities-2178391) in March 2023\. By April 2025, a Cambridge MPhil instructor [reported on Reddit](https://www.reddit.com/r/oxforduni/comments/1kapoya/oxford_studentslecturers_help_me_catch_your_ai/): “We moved to essentially oral exams… let students use AI as much as they want, given the condition that anything AI does wrong is considered their fault.”[^18] This quiet retreat from prohibition to structural redesign is the defining pattern of 2023–2026. [Yale produced a 121-page AI report](https://thenewjournalatyale.com/2025/10/inside-yales-quiet-reckoning-with-ai/) and committed $150 million, but left classroom policy to individual faculty—resulting in student confusion and inconsistent expectations. [Northwestern’s student newspaper](https://dailynorthwestern.com/2025/05/20/campus/northwestern-students-and-professors-navigate-confusion-opportunity-with-generative-ai/) reported “confusion and opportunity” as each professor implemented different policies. [McGill found](https://www.mcgilldaily.com/2026/01/is-ai-killing-academic-integrity/) that 88% of students used AI in Fall 2025, and responded by shifting all courses to in-person exams.[^19]
...
**Stanford**’s AI Working Group explicitly recommended “[in-person formats such as oral exams](https://communitystandards.stanford.edu/generative-ai-policy-guidance)” for AI-limited assessment,[^20] establishing oral examination as the university’s sensible default alongside a framework treating AI use as equivalent to collaboration requiring instructor permission.

**[The National University of Singapore](https://ctlt.nus.edu.sg/wp-content/uploads/2024/08/Policy-for-Use-of-AI-in-Teaching-and-Learning.pdf)** (ranked \#8 globally) wrote oral interviews directly into institutional AI policy: “If there is a need to test whether you possess a certain knowledge or capability without access to AI tools, your instructors will continue to arrange for appropriate assessment settings (e.g., an on-site proctored exam or oral interview).”[^21] NUS professors now say trying to catch AI use is a “lost cause”—but rather than despair, they redesigned assessment.

**[The University of British Columbia](https://www.arts.ubc.ca/news/how-ubc-arts-is-reshaping-teaching-and-learning-in-the-age-of-ai/)**’s Faculty of Arts launched the “We’re Only Human” program in February 2026, defining three approaches: AI-secure assessments (including “oral responses”), AI-open assessments, and hybrid models.[^22] The program title acknowledges that faculty and students are navigating uncertainty together—a more sophisticated framing than the adversarial “professors vs. cheaters” narrative.

**Cornell**’s English Language Support Office requires that students “[be prepared to orally discuss any content included in your paper](https://elso.as.cornell.edu/ai-and-academic-integrity).”[^23] This is elegant policy design: it does not mandate curriculum overhaul but shifts the burden to students. If you submit writing, you must be able to explain it orally. The mere expectation deters pure AI generation, builds oral fluency, and scales through spot-checking.

## **The South African Reframe**

Perhaps the most important strategic insight comes from South African scholarship. A [December 2023 study in *Cogent Education*](https://www.tandfonline.com/doi/full/10.1080/2331186X.2023.2295654) argued: “The perceived threat of ChatGPT to traditional assessment should spur professors to innovate and improve their assessments.”[^24] Drawing parallels to 1970s calculator debates, the authors noted that educators initially feared students would lose arithmetic skills—but eventually, curriculum adapted. The reframe is crucial: instead of “ChatGPT ruined assessment, what do we do?” the question becomes “ChatGPT exposed assessment weaknesses, how do we improve?” A [California community college that shifted all finals in-person](https://www.edsurge.com/news/2025-02-14-after-chatgpt-this-community-college-made-every-final-exam-in-person) found that optional oral components were actually *more accessible* for students with test anxiety and learning disabilities—challenging the assumption that oral exams are inherently exclusionary.[^25]

# **IV. Harvard’s Own Traditions: We Already Do This**
...
**[History & Literature](https://histlit.fas.harvard.edu/senior-oral-exam)** (founded 1906\) requires a one-hour senior oral exam: five prepared topics, three faculty examiners, and a tradition that has produced alumni including Conan O’Brien and Frank Rich.[^26] The concentration also requires three mandatory [oral presentations in sophomore tutorials](https://ablconnect.harvard.edu/book/oral-presentations), graded on a six-category rubric covering summary, source analysis, cross-source connections, contextualization, discussion questions, and presentation style. This is the French *colles* model implemented at Harvard: low-stakes formative practice building toward a high-stakes capstone.

**[Social Studies](https://socialstudies.fas.harvard.edu/oral-examinations)** requires a 1.5-hour comprehensive oral: thesis defense plus a general exam on the concentration’s core course.[^27] Students write a 1,000-word “intellectual autobiography” in preparation. The exam has been mandatory for all seniors since 1960—66 years of continuous oral assessment demonstrating both feasibility and rigor.

**[Folklore & Mythology](https://folkmyth.fas.harvard.edu/concentration-requirements)** (founded 1967\) requires all concentrators—not just honors students—to complete a general examination with both written and oral components in their final term.[^28] The concentration’s focus on oral traditions, oral literature, and oral performance makes the assessment format philosophically aligned with the subject matter. If a concentration studying how human societies preserved knowledge through spoken word requires oral examination, the principle extends naturally to any discipline where understanding matters more than artifact production.
...
**Harvard Business School** has used [the case method](https://www.hbs.edu/teaching-learning/Pages/case-method.aspx) since 1908, devoting up to 80% of class time to oral discussion and grading class contribution at 40–50% of course grades.[^29] With approximately 900 MBA students and case discussions in every required course, HBS conducts thousands of hours of oral assessment annually. If the Business School can grade oral contribution for all students across two years, the College can assess 6,700 undergraduates.

**Harvard Medical School** requires [OSCEs](https://medstudenthandbook.hms.harvard.edu/104-student-assessment-md-program)—clinical simulation exercises using standardized patients, objective rubrics, and multiple testing stations—for every MD student.[^30] HMS addresses the “subjectivity” objection directly: OSCEs are classified as “quantitative” assessment with structured scoring. If oral-performative assessment can be rigorous enough for life-or-death medical competency, it is rigorous enough for undergraduate coursework.

**Harvard Kennedy School**’s [Master in Public Policy](https://www.hks.harvard.edu/educational-programs/masters-programs/master-public-policy) program culminates in the Policy Analysis Exercise, with oral presentations each spring. **Harvard Law School** pioneered the Socratic method in 1870—156 years of oral pedagogy making live dialogue the foundation of legal education.
...
# **V. Philosophical Foundations: From Plato to Derrida**
...
The evidence on bias is clear and sobering. Accent, gender, race, and articulateness all influence unstructured oral grading. [CU Boulder’s NSF-funded research](https://www.colorado.edu/research/ai-institute/2025/01/22/tackling-bias-automatic-speech-recognition-two-examples-our-ongoing-work) found 24% lower automatic speech recognition accuracy for Black speakers, and [Ohio State analysis](https://ascode.osu.edu/news/ai-and-auto-grading-higher-education-capabilities-ethics-and-evolving-role-educators) showed AI grading systematically compresses score distributions—lenient on low-performing work, harsh on high-performing work.[^40] [Additional research](https://arxiv.org/abs/2405.06150) documents ASR bias against disfluent speech: pauses, self-corrections, and “um”s are misrepresented in transcription, and disfluency correlates with anxiety, ESL status, and neurodiversity.[^41]
...
# **VIII. What the Professions Already Know**
...
# **IX. Implementation: A Practical Framework for Harvard Faculty**
...
**Position Harvard as a leader.** No major American research university has yet produced a comprehensive framework for oral assessment in the AI era. Harvard has the history (founded on oral disputation), the infrastructure (tutorial system, professional school expertise), the resources (Bok Center, favorable student-faculty ratio), and the institutional reputation to define best practice for the sector. The [*Washington Post*](https://www.washingtonpost.com/education/2025/12/12/ai-artificial-intelligence-college-oral-exam/) has already documented a national “renaissance” of oral assessment[^45]—the question is whether Harvard will lead the movement or follow it.

# **X. The Reframe: From Crisis Response to Educational Recovery**
...
This document was prepared by the Bok Center for Teaching and Learning in collaboration with the Learning Lab, synthesizing research from an automated multi-cycle literature review covering 65+ sources across eight thematic domains. The research was conducted February 20–24, 2026\. For questions, workshop requests, or implementation support, contact the Bok Center at bokcenter@harvard.edu.

[^1]: HEPI, 'Students and AI: 2025 Survey,' Higher Education Policy Institute (2025). Reports 88% UK undergraduate AI usage, up from 53% in 2024\.
...
[^4]: Harvard Business School, 'The HBS Case Method.' Up to 80% of class time devoted to oral discussion; class contribution 40–50% of course grades.
...
[^6]: History & Literature concentration, Harvard University. 1-hour senior oral exam; five prepared topics; three faculty examiners. Program founded 1906\.

[^7]: Social Studies concentration, Harvard University. 1.5-hour comprehensive oral: thesis defense \+ general exam. Required for all seniors since 1960\.

[^8]: Folklore & Mythology, Harvard University. General exam with written \+ oral components required for all concentrators. Program founded 1967\.

[^9]: Christopher Stray, 'A Peculiar Institution: The Examination in 19th-Century Cambridge,' History of Universities (2001).

[^10]: Christopher Stray, 'A Peculiar Institution: The Examination in 19th-Century Cambridge,' History of Universities (2001).

[^11]: Classes Préparatoires aux Grandes Écoles (CPGE). Twice-weekly 'colles' (oral exams) across all subjects for 2 years; 200+ years continuous tradition.

[^12]: Union Public Service Commission (India): 275-mark viva voce as mandatory final stage. 150+ years continuous tradition.

[^13]: Colin M. MacLeod et al., 'The Production Effect: Delineation of a Phenomenon,' Journal of Experimental Psychology: Learning, Memory, and Cognition 36:3 (2010), 671–685.
...
[^16]: Frontiers in Education (2024): Oral exams create 'cognitive apprenticeship' where experts make invisible thinking visible.

[^17]: Review of Educational Research (Sage, January 2025): Meta-analysis found oral language and written composition are mutually reinforcing.

[^18]: Cambridge MPhil instructor (Reddit, April 2025): 'We moved to essentially oral exams... let students use AI as much as they want.'

[^19]: McGill Daily, 'Is AI Killing Academic Integrity?' (January 2026).

[^20]: Stanford AIWG, 'Generative AI and Education: Recommendations for the Stanford Community' (March 2024).
...
[^23]: Cornell English Language Support Office, 'AI and Academic Integrity' (September 2025). Students must 'be prepared to orally discuss any content included in your paper.'

[^24]: Cogent Education (Taylor & Francis, December 2023): 'The perceived threat of ChatGPT to traditional assessment should spur professors to innovate.'

[^25]: EdSurge (February 2025): California community college shifted all finals in-person; found oral components 'more accessible' for diverse learners.

[^26]: History & Literature concentration, Harvard University. 1-hour senior oral exam; five prepared topics; three faculty examiners. Program founded 1906\.

[^27]: Social Studies concentration, Harvard University. 1.5-hour comprehensive oral: thesis defense \+ general exam. Required for all seniors since 1960\.

[^28]: Folklore & Mythology, Harvard University. General exam with written \+ oral components required for all concentrators. Program founded 1967\.

[^29]: Harvard Business School, 'The HBS Case Method.' Up to 80% of class time devoted to oral discussion; class contribution 40–50% of course grades.

[^30]: Harden et al., 'Assessment of Clinical Competence Using an Objective Structured Clinical Examination,' British Medical Journal 1 (1975), 447–451.

[^31]: Plato, Phaedrus (c. 370 BCE), trans. B. Jowett. Socrates argues writing produces 'the appearance of wisdom, not the reality.'

[^32]: Walter J. Ong, Orality and Literacy: The Technologizing of the Word (Methuen, 1982).

[^33]: Brian Street, Literacy in Theory and Practice (Cambridge University Press, 1984). Distinguishes 'autonomous' from 'ideological' models of literacy.

[^34]: Cicero, De Oratore (55 BCE). Five canons of rhetoric: Invention, Arrangement, Style, Memory, Delivery.

[^35]: CQUniversity, Australia. 600 oral exams conducted in under one week for first-year literacy course (2023).

[^36]: Georgia Tech, 'Socratic Mind' platform. Piloted with 5,000+ students; 70–95% positive experience ratings.

[^37]: Panos Ipeirotis, NYU Stern School of Business. Pilot using ElevenLabs voice agent; $0.42/student cost; 89% grade alignment using council of LLMs.

[^38]: Classes Préparatoires aux Grandes Écoles (CPGE). Twice-weekly 'colles' (oral exams) across all subjects for 2 years; 200+ years continuous tradition.

[^39]: Sherpa tool (Stanford undergrads): AI transcribes oral responses, flags weak answers for instructor review. Enables asynchronous scheduling.

[^40]: CU Boulder NSF research: 24% lower ASR accuracy for Black speakers; Ohio State: AI grading compresses score distributions.

[^41]: arXiv (May 2024): ASR bias against disfluent speech—pauses, self-corrections, and 'um's misrepresented. Correlates with anxiety, ESL status, neurodiversity.

[^42]: Frontiers in Education (2024): Objective assessment criteria eliminate bias in non-anonymous grading. No disparities found when rubrics were used.

[^43]: EdSurge (February 2025): California community college shifted all finals in-person; found oral components 'more accessible' for diverse learners.

[^44]: Harden et al., 'Assessment of Clinical Competence Using an Objective Structured Clinical Examination,' British Medical Journal 1 (1975), 447–451.

[^45]: Washington Post (December 2025): Documented national 'renaissance' of oral assessment in higher education.
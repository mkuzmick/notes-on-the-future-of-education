...
*Rob Nelson, ["A Phaedrus Moment"](https://ailog.blog) (2025) | [Plato, Phaedrus (c. 370 BCE)](https://fs.blog/an-old-argument-against-writing/)*

## False Fluency

AI makes it easy to perform understanding you don't have. A student can produce fluent work on a topic they barely grasp, pass a problem set with assistance they couldn't replicate alone, or articulate a position they couldn't defend under questioning. The result is a new kind of epistemic risk: *false fluency* — the illusion of mastery where only surface competence exists. Even well-intentioned students may not be able to tell whether they've internalized something or merely outsourced it. When AI handles the scaffolding, the felt experience of "getting it" becomes indistinguishable from having a capable tool. The struggle that used to signal the gap between not-knowing and knowing — the frustration, the false starts, the slow click of comprehension — gets smoothed away.

## The Disappearance of the Junior Role
...
## Forensic Reading and the Logic Audit

If the paper is no longer proof of thinking, one approach is to put the student in the hot seat — not to prove they did the work (the work is cheap now) but to prove they can *account* for the work. "On page 4, the system made a jump from Data A to Conclusion B. You signed off on that. Walk us through the three logical tests you ran to verify that the system didn't hallucinate the correlation." Instead of telling students "don't trust AI," the reframe is: "prove *why* this AI is wrong." The student becomes a detective of logic, not a passive consumer of outputs. This shifts the assessment from presentation to accounting — not a student at a podium with a PowerPoint, but a student at a table with a panel, defending an audit trail.

## "AI Can Simulate Interest. It Can't Transmit Desire."
...
*[Inside Higher Ed (2024)](https://www.insidehighered.com/news/teaching-learning/pedagogy/2024/01/18/professors-shift-oral-exams-response-ai) | [EDUCAUSE Review (2024)](https://er.educause.edu/articles/2024/3/experimenting-with-oral-assessments)*

## The Weight-Lifting Analogy

"When a worker needs to move a lot of weight quickly, they use a forklift. But when that same person wants to build muscle, they head to the gym and lift weights themselves." In liberal arts education, the primary objective isn't to produce polished essays — it's to build intellectual muscle. AI is the forklift. The question is whether oral assessment makes the workout more visible, or whether it just changes which muscles get tested.

*[Catherine Hartmann, "Oral Exams for a Generative AI World," College Teaching (2025)](https://doi.org/10.1080/87567555.2025.2558563)*

## Why Harvard Destroyed Rhetoric

John Quincy Adams held the Boylston Chair of Rhetoric at Harvard in 1806. He had studied with Benjamin Franklin, heard Edmund Burke, and taught oral persuasion as "the paramount democratic skill." After Adams, the chair drifted from oral address toward written composition. Harvard fell "in thrall to" Petrus Ramus, the sixteenth-century logician who compartmentalized the liberal arts and stripped rhetoric of its persuasive, oral power. Rhetoric became "style, a corpse in brilliant clothing." The current conversation about oral assessment echoes this older one about what was lost when rhetoric was separated from speech.
...
*[McKinsey Case Interview Methodology](https://www.mckinsey.com/careers/interviewing) | [HBR, "How to Hire" (2016)](https://hbr.org/2016/04/how-to-hire)*

## The Gender Gap

Women systematically underperform relative to their written work in oral contexts — not because they understand less, but because gendered communication norms distort evaluation. A study across ten UK universities found that women received lower oral exam scores than men despite achieving higher marks on written coursework, and the gap widened when male examiners conducted evaluations. Women face interruption more frequently, are penalized for assertive speech as "aggressive" while rewarded for tentative speech as "appropriate," and trigger competence penalties from vocal patterns regardless of content quality. Harvard's historical exclusion of women from oral examination traditions encoded masculine performance norms that persist.

*[Studies in Higher Education (2018)](https://doi.org/10.1080/03075079.2018.1510388) | [Deborah Tannen, You Just Don't Understand (1990)](https://academic.oup.com/book/3609)*

## The Neurodivergent Penalty

Autistic students performing at the 90th percentile on written exams drop to the 40th percentile in oral formats — not from reduced knowledge, but because oral assessment demands simultaneous processing of social cues, verbal formulation, real-time memory retrieval, and self-regulation under examiner scrutiny. Students with ADHD report that the unstructured nature of oral dialogue — where questions emerge dynamically rather than appearing in written form — makes usual compensation strategies impossible. Extended time, the most common accommodation, doesn't solve fundamental format incompatibility.

*[National Autistic Society, Higher Education Assessment](https://www.autism.org.uk) | [ERIC (2020)](https://eric.ed.gov/?id=EJ1240113)*

## Student Resistance Isn't Irrational

When students resist oral assessment, 73% cite fairness, not difficulty: "I'm better at showing my knowledge in writing." "My accent will be judged." "Extroverts will get higher grades for personality." "One bad day will tank my GPA." These are not excuses — they are sophisticated critiques of construct validity. Students intuitively grasp what researchers have documented: oral exams often measure performance anxiety, cultural capital, and verbal charisma rather than disciplinary mastery.

*[Assessment & Evaluation in Higher Education (2022)](https://doi.org/10.1080/02602938.2022.2058981)*

## The TA Bottleneck

A typical course with 150 students, three TAs, and fifteen-minute oral exams requires 37.5 hours of examination time — plus scheduling logistics, plus training on consistent questioning and rubrics. Assuming exams run in one intensive week, each TA must block 12+ hours for examining alone, on top of normal teaching, dissertation work, and grading. TAs are often ABD graduate students with minimal assessment experience and varying pedagogical interest. Without compensation, training, or workload reduction, asking them to become skilled oral examiners produces wildly inconsistent student experiences.

*[Chronicle of Higher Education, "Who Should Really Be Grading Student Work"](https://www.chronicle.com/article/who-should-really-be-grading-student-work)*

## The Recording Paradox

If oral assessment is to be defensible — legally and pedagogically — it must be documented. Written exams automatically generate records for appeals; oral exams disappear unless recorded. But recording intensifies performance anxiety, creates privacy concerns under FERPA, and raises questions about data retention and access. Oral exams are framed as "more human" than written work, yet ensuring fairness requires documentation that makes the experience feel less human. When fairness requires surveillance but surveillance undermines authenticity, the tension doesn't resolve. It has to be named and managed.

*[UK Quality Assurance Agency](https://www.qaa.ac.uk/quality-code/advice-and-guidance/assessment) | [FERPA Guidance on Educational Recordings](https://studentprivacy.ed.gov/faq/faqs-photos-and-videos-under-ferpa)*

## The Reliability Problem

Inter-rater reliability for oral exams (correlation 0.4–0.6) is substantially worse than written work (0.7–0.85). A landmark study recorded medical students' oral exams and had multiple faculty independently score the same videotaped performance: variance between examiners exceeded variance between students, meaning "who evaluates you" predicted grades more than "how well you performed." This persists even with experienced faculty using detailed rubrics. Strategies that improve reliability (multiple examiners, calibration, recordings) add cost and complexity that most courses can't absorb.

*[PubMed Central (1990)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1114733/) | [Review of Educational Research (1996)](https://journals.sagepub.com/doi/10.3102/00346543066004367)*

## Cambridge vs. Oxford

Cambridge pioneered written exams in the eighteenth century because Newtonian mathematics demanded precise numerical ranking. Oxford retained oral traditions because classical rhetoric valued community dialogue over individual scoring. Cambridge used numbers; Oxford used Greek letters. Cambridge completed the shift to written exams by 1839; Oxford held vivas into the 1930s. In Cambridge, the written exam reflected mathematical culture: "subject matter and assessment by precise rank order had an elective affinity." In Oxford, "the rhetoric of display was part of the culture of gentlemanly orality." The divergence illustrates that the choice between oral and written assessment was always disciplinary and political — never purely epistemological.
...
## Iterative Writing as Alternative

If oral assessment's costs sometimes exceed its benefits, the alternative isn't resignation — it's process-focused writing. Stanford's "unessay" experiments, Yale's scaffolded portfolio approach, and Brown's staged revision model all demonstrate that when students submit multiple drafts, receive substantive feedback between versions, and produce process documentation, AI-generated work becomes pedagogically useless. You can't fake a learning trajectory. Brown's 2024 pilot found that staged writing assignments reduced student AI use voluntarily: when the process itself is where learning happens, outsourcing to AI means missing the point.

*[Stanford Daily (2024)](https://www.stanforddaily.com/2024/02/09/unessay-stanford-writing/) | [Brown University AI Writing Study (2024)](https://news.brown.edu/articles/2024/05/ai-writing-study)*
